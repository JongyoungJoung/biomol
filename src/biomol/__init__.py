...
- `APP_NAME`: The name of the module. (alias of `__name__`) (e.g., `biomol`)  
- `APP_NAME_UPPER`: The name of the module in uppercase. (e.g., `BIOMOL`)  
- `PACKAGE_NAME`: The name of the package. (replaces `_` with `-`) (e.g., `biomol`)  
